...
const phase2FeatureRows = [
  ...
  ["机器人运维", "新增", "画面/列表/全屏视图", "三种视图使用同一筛选结果，按在线、异常、离线排序；桌面宽屏画面区每行展示5个卡片，直播画面保持3:2，较窄窗口按3列、2列、1列响应式收缩；切换视图或进入、退出全屏时保留筛选条件。", "上一版本没有面向多设备的画面墙、列表和全屏值守能力。", true],
  ...
  ["机器人运维", "新增", "设备详情与最近告警", "详情ID显示为RBT加数字序号；字段按基础信息、直播运行、内容执行、设备连接四组紧凑展示，减少无层级平铺和空间浪费；电机状态区独立展示1至15号圆形编号，正常为绿色、异常为红色、未检测为灰色；最近告警固定展示最近6条，不继承页面告警筛选。", "上一版本设备信息停留在配置字段，缺少分组后的完整运行状态、电机明细和告警上下文。", true],
