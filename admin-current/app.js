...
const phase2ComparisonRows = [
  ...
  ["机器人运维", "上一版本以机器人资料、技能、表演和脚本绑定为主。", "本版本补齐品牌化运维头部、直播设备范围、筛选与指标口径、画面/列表/全屏值守、统一画面状态位、告警联动、设备详情、跨页处理和实时订阅。"],
...
const phase2FocusRows = [
  ...
  ["机器人运维联动", "把直播设备范围、筛选、指标、画面、告警、详情、跨页处理和实时订阅串成完整值守闭环。"],
  ...
  return [
    {
      ...
      summaryItems: [
        ...
        "新增品牌化机器人运维大屏、统一画面状态位、设备详情、告警筛选和直播大屏联动",
